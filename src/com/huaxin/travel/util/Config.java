...
public class Config{
	...
	public static String USER = "H9KCoMjnAn3Z8GFW39WKQPF2";
	public static String PWD = "xI7wmXtLG0EoDZu2GBw86a88bqpYysoV";

  	/***MySQL相关配置***/
	public static String MYSQLNAME = "MbcIiKzGsxHIRLESigXe";
	...
	/***BCS配置***/
  	...
  	public static String BUCKET="trip-upload-bucket";
